...
@Autonomous(name = "Auto: RED 3", group = "Autos")   // How opmode is displayed on phones
public class AutoRed3 extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        doLinearMovementTime("left", 0.05f, 1.5);
        doLinearMovementTime("stop", 0, 0.15);
        // Turn so base plate is in proper orientation
        doTurn(true, 180, 0.04f);
        doLinearMovementTime("stop", 0, 0.15);
        // Move towards depot
        doLinearMovementTime("forwards", 0.05f, 1);
        doLinearMovementTime("stop", 0, 0.15);
        ...
        doLinearMovementSensor("forwards", 0.05f, "distRear", 48, true);
        doLinearMovementTime("stop", 0, 0.15);
        // Move sideways until under bridge
        doLinearMovementSensor("left", 0.05f, "distTop", 30, false);
        doLinearMovementTime("stop", 0, 0.15);
        /** [DRIVING CODE STOP] */
